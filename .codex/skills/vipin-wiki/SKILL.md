...
- **Physical file organization**: delegate manifests, age-gated move plans, approved batch moves, and rollbacks to `D:\agent-resources\skills\vipin\workstation-maintenance`; this skill records only public-safe routing updates after dry-run evidence or actual changes.
