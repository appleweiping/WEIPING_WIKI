...
`darwin-skill` is a local D-drive repository for optimizing agent skills through iterative evaluation, improvement, testing, human confirmation, and git-controlled retention or rollback.
...
- EXTRACTED: The root `SKILL.md` describes an 8-dimension rubric covering structure and real-world effectiveness.
- INFERRED: This repository is relevant for auditing, scoring, and improving existing skills rather than merely collecting them.
