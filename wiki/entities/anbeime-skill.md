...
`anbeime-skill` is a local D-drive skill-store repository under `D:/Skill/anbeime-skill`.

## Current Claims

- EXTRACTED: The repository tracks `https://github.com/appleweiping/skill.git` on branch `main`.
- EXTRACTED: The original upstream repository is `https://github.com/anbeime/skill.git`.
- EXTRACTED: At the 2026-05-16 trace, local HEAD was `6646c3a64cd3e2a4f8cb3703c3a298086d4c6dc9`; upstream `HEAD` was `049efd5f29fb47c9165871caac4e61b4c67cb2c9`, so the local fork was not exactly at upstream HEAD.
...
- Local root: `D:/Skill/anbeime-skill`.
- Git remote: `https://github.com/appleweiping/skill.git`.
