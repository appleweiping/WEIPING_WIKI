---
title: "Grounded Spatial Reasoning Layouts"
type: source
status: imported
created: 2026-05-15
updated: 2026-05-18
tags:
  ...
  - openai
source_pages:
  - https://developers.openai.com/cookbook/examples/multimodal/grounded_spatial_reasoning_layouts
  - https://github.com/openai/openai-cookbook/blob/main/examples/multimodal/grounded_spatial_reasoning_layouts.ipynb
---

# Grounded Spatial Reasoning Layouts

## Source

- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/multimodal/grounded_spatial_reasoning_layouts
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/multimodal/grounded_spatial_reasoning_layouts.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/multimodal/grounded_spatial_reasoning_layouts.ipynb
- Source path: `examples/multimodal/grounded_spatial_reasoning_layouts.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `70ffd9d8483649de5e6e669551128aaf7ae5a74060c75d29f94321fb995fbcc0`
