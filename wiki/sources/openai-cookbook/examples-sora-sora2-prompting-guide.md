...
# Sora2 Prompting Guide

## Source

- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/sora/sora2_prompting_guide
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/sora/sora2_prompting_guide.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/sora/sora2_prompting_guide.ipynb
- Source path: `examples/sora/sora2_prompting_guide.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `0de356fb60ec5d56fd3df4c2850faf5620a7cee29908a07c948d64cb89d9df79`
...
Sora 2: Prompting Guide Crafting a successful video prompt Updated - March 2026 This guide has been updated to reflect the latest Sora API capabilities, including: - Character references (objects and animals) – Upload a character once and reuse it across videos with consistent appearance. - Higher-resolution exports – Generate videos in 1920×1080 or 1080×192...
...
| ![Original Video 1](https://cdn.openai.com/API/docs/images/sora/sora_monster_original.gif)<p><small>Original Video</small></p> | ![Edited Video 2](https://cdn.openai.com/API/docs/images/sora/sora_monster_2monsters.gif)<p><small>_Edit prompt: "A second monster comes out right after"_</small></p> |
...
```
Below are three generated GIF examples using an uploaded character of a dog named Alfie. The leftmost video is the original reference used to create the character

| Input character video | Generation 1 | Generation 2 | Generation 3 |
| --- | --- | --- | --- |
| <img src="gifs/alfie_input.gif" width="220"> | <img src="gifs/alfie_museum.gif" width="220"> | <img src="gifs/alfie_f1.gif" width="220"> | <img src="gifs/alfie_tokyo.gif" width="220"> |
