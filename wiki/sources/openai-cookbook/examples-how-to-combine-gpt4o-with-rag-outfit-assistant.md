---
title: "How To Combine Gpt4o With Rag Outfit Assistant"
type: source
status: imported
created: 2026-05-15
updated: 2026-05-18
...
source_pages:
  ...
  - https://github.com/openai/openai-cookbook/blob/main/examples/How_to_combine_GPT4o_with_RAG_Outfit_Assistant.ipynb
---

# How To Combine Gpt4o With Rag Outfit Assistant

## Source

- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/how_to_combine_gpt4o_with_rag_outfit_assistant
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/How_to_combine_GPT4o_with_RAG_Outfit_Assistant.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/How_to_combine_GPT4o_with_RAG_Outfit_Assistant.ipynb
- Source path: `examples/How_to_combine_GPT4o_with_RAG_Outfit_Assistant.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `ac446dabc2037e1242dc2c4bcc799e1dec5f2754d084a06ee82aed112ad32ca0`
...
How to Combine GPT-4o Mini with RAG - Create a Clothing Matchmaker App Welcome to the Clothing Matchmaker App Jupyter Notebook! This project demonstrates the power of the GPT-4o mini model in analyzing images of clothing items and extracting key features such as color, style, and type. The core of our app relies on this advanced image analysis model develope...
