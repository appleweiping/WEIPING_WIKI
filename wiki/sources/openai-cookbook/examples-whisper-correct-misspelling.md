---
title: "Whisper Correct Misspelling"
type: source
status: imported
created: 2026-05-15
updated: 2026-05-18
tags:
  ...
  - voice
source_pages:
  - https://developers.openai.com/cookbook/examples/whisper_correct_misspelling
  - https://github.com/openai/openai-cookbook/blob/main/examples/Whisper_correct_misspelling.ipynb
---

# Whisper Correct Misspelling

## Source

- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/whisper_correct_misspelling
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/Whisper_correct_misspelling.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/Whisper_correct_misspelling.ipynb
- Source path: `examples/Whisper_correct_misspelling.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `1c5835752a79f969ec32daba80b65d01095808fe4a7eea9c014ef61f5a70143c`
...
Addressing transcription misspellings: prompt vs post-processing We are addressing the problem of enhancing the precision of transcriptions, particularly when it comes to company names and product references. Our solution involves a dual strategy that utilizes both the Whisper prompt parameter and GPT-4's post-processing capabilities. Two approaches to corre...
