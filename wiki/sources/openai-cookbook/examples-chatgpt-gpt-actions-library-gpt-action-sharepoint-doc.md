---
title: "Gpt Action Sharepoint Doc"
type: source
status: mirrored
created: 2026-05-15
updated: 2026-05-18
tags:
  ...
  - openai
source_pages:
  - https://developers.openai.com/cookbook/examples/chatgpt/gpt_actions_library/gpt_action_sharepoint_doc
  - https://github.com/openai/openai-cookbook/blob/main/examples/chatgpt/gpt_actions_library/gpt_action_sharepoint_doc.ipynb
---

# Gpt Action Sharepoint Doc

## Source

- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/chatgpt/gpt_actions_library/gpt_action_sharepoint_doc
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/chatgpt/gpt_actions_library/gpt_action_sharepoint_doc.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/chatgpt/gpt_actions_library/gpt_action_sharepoint_doc.ipynb
- Source path: `examples/chatgpt/gpt_actions_library/gpt_action_sharepoint_doc.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `6f7f8a266397fa32c6e894a5a8cd10e81d8e09c7f94c8defa17716b08228d501`
...
GPT Action Library: Sharepoint (Return file for Data Analysis / Document Summarization) Introduction This page provides an instruction & guide for developers building a GPT Action for a specific application. Before you proceed, make sure to first familiarize yourself with the following information: - Introduction to GPT Actions - Introduction to GPT Actions...
