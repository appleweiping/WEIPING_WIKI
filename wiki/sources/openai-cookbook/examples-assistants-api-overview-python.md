---
title: "Assistants Api Overview Python"
type: source
status: mirrored
created: 2026-05-15
updated: 2026-05-18
tags:
  ...
  - openai
source_pages:
  - https://developers.openai.com/cookbook/examples/assistants_api_overview_python
  - https://github.com/openai/openai-cookbook/blob/main/examples/Assistants_API_overview_python.ipynb
---

# Assistants Api Overview Python

## Source

- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/assistants_api_overview_python
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/Assistants_API_overview_python.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/Assistants_API_overview_python.ipynb
- Source path: `examples/Assistants_API_overview_python.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `fe83c608c7711ab92bfe0cfb71119cabcf6c6758d54313859adaa0c4108fd667`
