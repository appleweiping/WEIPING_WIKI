...
- Canonical Cookbook page: https://developers.openai.com/cookbook/articles/gpt-oss/run-transformers
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/articles/gpt-oss/run-transformers.md
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/articles/gpt-oss/run-transformers.md
- Source path: `articles/gpt-oss/run-transformers.md`
- Source kind: `articles`
- Source format: `.md`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `12dba93671b6ccc4c2e973b446e0ae2169909d69122450016724c14d8ce207af`
