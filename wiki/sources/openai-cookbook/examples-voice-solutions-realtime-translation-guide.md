---
title: "Realtime Translation Guide"
type: source
status: mirrored
created: 2026-05-15
updated: 2026-05-15
...
- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/voice_solutions/realtime_translation_guide
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/voice_solutions/realtime_translation_guide.mdx
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/voice_solutions/realtime_translation_guide.mdx
- Source path: `examples/voice_solutions/realtime_translation_guide.mdx`
- Source kind: `examples`
- Source format: `.mdx`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `6a678639634ebda136b619da94fe36f95840fff69e3f66f32c6e3ac733b95667`
...
Build Live Translation Apps with gpt-realtime-translate gpt-realtime-translate is a live speech-to-speech translation model for building multilingual audio experiences across broadcasts, streams, calls, and video conversations. It accepts spoken input, automatically detects the source language, and returns translated speech plus text transcripts. Developers...
