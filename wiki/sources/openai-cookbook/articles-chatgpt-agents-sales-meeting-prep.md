---
title: "Chatgpt Agents Sales Meeting Prep"
type: source
status: mirrored
created: 2026-05-15
updated: 2026-05-15
...
- Canonical Cookbook page: https://developers.openai.com/cookbook/articles/chatgpt-agents-sales-meeting-prep
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/articles/chatgpt-agents-sales-meeting-prep.md
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/articles/chatgpt-agents-sales-meeting-prep.md
- Source path: `articles/chatgpt-agents-sales-meeting-prep.md`
- Source kind: `articles`
- Source format: `.md`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `56a464501c12e32516985c050deca6e3dcdb44a2cb7fc9cadca0a8b734e59748`
...
Building workspace agents in ChatGPT to complete repeatable, end-to-end work This cookbook shows how to build a ChatGPT workspace agent. Currently available in research preview for ChatGPT Business, Enterprise, and Edu customers, workspace agents are evolutions of GPTs that can work across tools to complete high-value tasks, helping your team move faster. In...
