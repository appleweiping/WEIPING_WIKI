...
tags:
  ...
  - openai
source_pages:
  - https://developers.openai.com/cookbook/examples/batch_processing
...
- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/batch_processing
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/batch_processing.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/batch_processing.ipynb
- Source path: `examples/batch_processing.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `693604fe7cd8a071ad391c98081ab5326da980c767085421d037261e96a41008`
...
Batch processing with the Batch API The new Batch API allows to create async batch jobs for a lower price and with higher rate limits . Batches will be completed within 24h, but may be processed sooner depending on global usage. Ideal use cases for the Batch API include: - Tagging, captioning, or enriching content on a marketplace or blog - Categorizing and...
