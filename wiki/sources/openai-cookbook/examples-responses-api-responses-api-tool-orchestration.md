---
title: "Responses Api Tool Orchestration"
type: source
status: mirrored
created: 2026-05-15
updated: 2026-05-15
...
- Canonical Cookbook page: https://developers.openai.com/cookbook/examples/responses_api/responses_api_tool_orchestration
- OpenAI Cookbook source: https://github.com/openai/openai-cookbook/blob/main/examples/responses_api/responses_api_tool_orchestration.ipynb
- Raw source: https://raw.githubusercontent.com/openai/openai-cookbook/main/examples/responses_api/responses_api_tool_orchestration.ipynb
- Source path: `examples/responses_api/responses_api_tool_orchestration.ipynb`
- Source kind: `examples`
- Source format: `.ipynb`
- License basis: OpenAI Cookbook repository MIT license.
- Content hash: `be7300e7ffc9e383cc462a4a47e2db0279fb78b88fa938bcbbe3be484dc18686`
