---
title: 学长的建议：关于如何比较baseline是公平的，其实不同paper的定义不同，只要看起来你的标准是统一的就可以，我可以举几个例子
type: source
status: active
created: 2026-05-16
updated: 2026-05-16
...
# 学长的建议：关于如何比较baseline是公平的，其实不同paper的定义不同，只要看起来你的标准是统一的就可以，我可以举几个例子

## Metadata

- Stable ID: `codex-user-prompt:92df1b33c5d14a8e`
- Source kind: `codex-session-user`
- Category: `research-workflow`
- Timestamp: `2026-05-08T09:11:29.576Z`
- Semantic hash: `92df1b33c5d14a8e0f3a41b67083da0486459724a8c00aa33fc4ecd01ab47e5e`
...
你建议怎么改，建议你自己制定最优方案，进行改动，做好全过程，不管是代码，报告，贡献，结论等。必要时做增删改查。用多agent协作
```
