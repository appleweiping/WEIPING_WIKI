...
- [[local-cc-sidecar-agent-workflow]] - Strict three-role Codex + Claude Code workflow with PixelCat preflight: Codex coordinates/writes, Opus reviews deeply, and Sonnet scans low-risk diffs/docs.
