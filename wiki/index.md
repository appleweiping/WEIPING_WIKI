...
This is the main catalog of the wiki.
...
- [[yao-shunyu-alfred]] - alfredyao public corpus for physics-to-AI, Google DeepMind/Anthropic, quantum physics, RL, and agentic coding.
- [[yao-shunyu-ysymyth]] - ysymyth public corpus for language agents, OpenAI work, ReAct, ToT, SWE-agent, SWE-bench, tau-bench, CUA, and Deep Research.
...
- [[analog-agent]] - AI4EDA layered analog circuit design workbench entry with SPICE/configured-truth boundaries, startup packet, module map, and artifact safety rules.
...
- [[vipinknowledge-maintenance-system]] - Continuous maintenance system for whole-computer project routing, workstation-maintenance handoff, weekly reports, skill self-upgrades, and scoped auto commit/push gates.
...
- [[whole-computer-project-map]] - First-stop routing map for whole-computer maintenance across C/D/G drives, importance-based depth, workstation move boundaries, active roots, archives, and safety boundaries.
...
- [[sources/weekly-research-digests/2026-w20-ai4eda-analog]] - 2026-W20 AI4EDA analog circuit design research pick.

- [[sources/weekly-research-digests/2026-w20-llm4rec]] - 2026-W20 LLM4Rec research pick.

- [[sources/weekly-research-digests/2026-w20-llm]] - 2026-W20 LLM research pick.

- [[sources/weekly-research-digests/2026-w20-ai]] - 2026-W20 AI research pick.
...
- [[2026-05-16-frontend-frameworks-public-corpus]] - Batch ingest of frontend project framework GitHub repositories, release summaries, reuse metadata, language profiles, and candidate discovery.
...
- [[frontend-framework-reuse-map]] - Reuse and migration map for captured frontend project frameworks.
- [[frontend-project-shell-taxonomy]] - Category map of captured frontend project frameworks by reusable shell role.
...
- [[2026-05-17-research-project-workbench-audit]] - Deep workbench audit for analog-agent plus the three local recommendation research projects, including tracked-file coverage, artifact inventory, claim gates, and collaboration-rule interpretation.

## Synthesis

- [[synthesis-home]] - Entry page for the `wiki/synthesis/` section.
- [[synthesis/sessions/README|synthesis sessions]] - Session-level synthesis notes and crystallized checkpoints.
...
- [[2026-04-22-what-language-for-5eid0-computer-software-ui]] - Recommendation to start the 5EID0 base-station UI in Python with MQTT support and simple map visualization.
...
- Items
  ...
  - [[sources/shunyu-yao/alfredyao/paper-quantum-energy-teleportation-versus-information-teleportation-afc2f6acf4|Quantum Energy Teleportation versus Information Teleportation]] - `alfredyao`, `paper`
  - [[sources/shunyu-yao/alfredyao/paper-cv-00c65d5d10|CV]] - `alfredyao`, `paper-or-pdf`
  - [[sources/shunyu-yao/alfredyao/post-post-2025-10-06-9999f89dc9|post 2025 10 06]] - `alfredyao`, `post`
  - [[sources/shunyu-yao/alfredyao/post-post-2025-11-18-c37c3b8fbd|post 2025 11 18]] - `alfredyao`, `post`
  ...
  - [[sources/shunyu-yao/ysymyth/paper-hy-embodied-0-5-embodied-foundation-models-for-real-world-agents-c3a582b473|HY-Embodied-0.5: Embodied Foundation Models for Real-World Agents]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-intercode-standardizing-and-benchmarking-interactive-coding-with-execution-feedback-35b4baa298|InterCode: Standardizing and Benchmarking Interactive Coding with Execution Feedback]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-multi-objective-evolution-of-heuristic-using-large-language-model-02dd26ab48|Multi-objective Evolution of Heuristic Using Large Language Model]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-os-copilot-towards-generalist-computer-agents-with-self-improvement-02de2d3def|OS-Copilot: Towards Generalist Computer Agents with Self-Improvement]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-prompting-large-language-models-to-tackle-the-full-software-development-lifecycle-a-case-s-73c3f27b86|Prompting Large Language Models to Tackle the Full Software Development Lifecycle: A Case Study]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-provable-limitations-of-acquiring-meaning-from-ungrounded-form-what-will-future-language-m-81e3494b0c|Provable Limitations of Acquiring Meaning from Ungrounded Form: What Will Future Language Models Understand?]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-react-synergizing-reasoning-and-acting-in-language-models-cd5a07f0ad|ReAct: Synergizing Reasoning and Acting in Language Models]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-reflexion-language-agents-with-verbal-reinforcement-learning-20cc9d63a6|Reflexion: Language Agents with Verbal Reinforcement Learning]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-seal-self-evolving-agentic-learning-for-conversational-question-answering-over-knowledge-g-9a9cf5c6d8|SEAL: Self-Evolving Agentic Learning for Conversational Question Answering over Knowledge Graphs]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-swe-agent-agent-computer-interfaces-enable-automated-software-engineering-c8fb839775|SWE-agent: Agent-Computer Interfaces Enable Automated Software Engineering]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-swe-bench-can-language-models-resolve-real-world-github-issues-a548317afa|SWE-bench: Can Language Models Resolve Real-World GitHub Issues?]] - `ysymyth`, `paper`
  - [[sources/shunyu-yao/ysymyth/paper-tree-of-thoughts-deliberate-problem-solving-with-large-language-models-4224462bfa|Tree of Thoughts: Deliberate Problem Solving with Large Language Models]] - `ysymyth`, `paper`
  ...
  - [[sources/shunyu-yao/ysymyth/project-computer-using-agent-product-1693f5b69f|Computer-Using Agent product]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-deep-research-blogpost-b7b0bac261|Deep Research blogpost]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-google-ai-blogpost-0cca27a626|Google AI blogpost]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-intercode-project-4b771a9762|InterCode project]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-quanta-magazine-b64a94908a|Quanta Magazine]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-react-project-8732e80a56|ReAct project]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-swe-agent-project-a62fd10cd3|SWE-agent project]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-swe-bench-project-3552604bec|SWE-bench project]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-webshop-demo-a4cca767ea|WebShop demo]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/project-webshop-project-c7c510091b|WebShop project]] - `ysymyth`, `project-or-public-release`
  - [[sources/shunyu-yao/ysymyth/talk-on-formulating-and-evaluating-language-agents-4ff1143230|On Formulating and Evaluating Language Agents]] - `ysymyth`, `talk-or-slides`
...
- Agents SDK / agent workflows
  - [[sources/openai-cookbook/examples-agents-sdk-agent-improvement-loop|Agent Improvement Loop]]
  - [[sources/openai-cookbook/examples-agentkit-agentkit-walkthrough|Agentkit Walkthrough]]
  - [[sources/openai-cookbook/examples-agents-sdk-app-assistant-voice-agents|App Assistant Voice Agents]]
  - [[sources/openai-cookbook/examples-codex-codex-mcp-agents-sdk-building-consistent-workflows-codex-cli-agents-sdk|Building Consistent Workflows Codex Cli Agents Sdk]]
  - [[sources/openai-cookbook/examples-agents-sdk-building-reliable-agents-memory-compaction|Building Reliable Agents Memory Compaction]]
  - [[sources/openai-cookbook/examples-agents-sdk-computer-use-with-daytona-computer-use-with-daytona|Computer Use With Daytona]]
  - [[sources/openai-cookbook/examples-agents-sdk-context-personalization|Context Personalization]]
  - [[sources/openai-cookbook/examples-agents-sdk-dispute-agent|Dispute Agent]]
  - [[sources/openai-cookbook/examples-agents-sdk-evaluate-agents|Evaluate Agents]]
  - [[sources/openai-cookbook/examples-agents-sdk-multi-agent-portfolio-collaboration-multi-agent-portfolio-collaboration|Multi Agent Portfolio Collaboration]]
  - [[sources/openai-cookbook/examples-orchestrating-agents|Orchestrating Agents]]
  - [[sources/openai-cookbook/examples-agents-sdk-parallel-agents|Parallel Agents]]
  - [[sources/openai-cookbook/examples-agents-sdk-deployment-manager-readme|Readme]]
  - [[sources/openai-cookbook/examples-agents-sdk-sandboxed-code-migration-sandboxed-code-migration-agent|Sandboxed Code Migration Agent]]
  - [[sources/openai-cookbook/examples-object-oriented-agentic-approach-secure-code-interpreter-tool-for-llm-agents|Secure Code Interpreter Tool For Llm Agents]]
  - [[sources/openai-cookbook/examples-agents-sdk-session-memory|Session Memory]]
- ChatGPT / GPT Actions
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-getting-started|.Gpt Action Getting Started]]
  - [[sources/openai-cookbook/examples-chatgpt-rag-quickstart-azure-azure-ai-search-with-azure-functions-and-gpt-actions-in-chatgpt|Azure Ai Search With Azure Functions And Gpt Actions In Chatgpt]]
  - [[sources/openai-cookbook/articles-chatgpt-agents-sales-meeting-prep|Chatgpt Agents Sales Meeting Prep]]
  - [[sources/openai-cookbook/examples-chatgpt-chatgpt-prompt-guide-chatgpt-prompt-guide|Chatgpt Prompt Guide]]
  - [[sources/openai-cookbook/examples-chatgpt-rag-quickstart-gcp-getting-started-with-bigquery-vector-search-and-openai|Getting Started With Bigquery Vector Search And Openai]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-bigquery|Gpt Action Bigquery]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-box|Gpt Action Box]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-canvas|Gpt Action Canvas]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-confluence|Gpt Action Confluence]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-github|Gpt Action Github]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-gmail|Gpt Action Gmail]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-google-calendar|Gpt Action Google Calendar]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-google-drive|Gpt Action Google Drive]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-googleads-adzviser|Gpt Action Googleads Adzviser]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-jira|Gpt Action Jira]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-notion|Gpt Action Notion]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-outlook|Gpt Action Outlook]]
  - [[sources/openai-cookbook/examples-chatgpt-rag-quickstart-pinecone-retool-gpt-action-pinecone-retool-rag|Gpt Action Pinecone Retool Rag]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-redshift|Gpt Action Redshift]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-retool-workflow|Gpt Action Retool Workflow]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-salesforce|Gpt Action Salesforce]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-salesforce-gong|Gpt Action Salesforce Gong]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-sharepoint-doc|Gpt Action Sharepoint Doc]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-sharepoint-text|Gpt Action Sharepoint Text]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-snowflake-direct|Gpt Action Snowflake Direct]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-snowflake-middleware|Gpt Action Snowflake Middleware]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-sql-database|Gpt Action Sql Database]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-trayai-apim|Gpt Action Trayai Apim]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-workday|Gpt Action Workday]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-action-zapier|Gpt Action Zapier]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-middleware-aws-function|Gpt Middleware Aws Function]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-middleware-azure-function|Gpt Middleware Azure Function]]
  - [[sources/openai-cookbook/examples-chatgpt-gpt-actions-library-gpt-middleware-google-cloud-function|Gpt Middleware Google Cloud Function]]
  - [[sources/openai-cookbook/examples-chatgpt-compliance-api-logs-platform|Logs Platform]]
- Codex / coding agents
  - [[sources/openai-cookbook/examples-codex-autofix-github-actions|Autofix Github Actions]]
  - [[sources/openai-cookbook/examples-codex-build-code-review-with-codex-sdk|Build Code Review With Codex Sdk]]
  - [[sources/openai-cookbook/examples-codex-build-iterative-repair-loops-with-codex|Build Iterative Repair Loops With Codex]]
  - [[sources/openai-cookbook/examples-codex-code-modernization|Code Modernization]]
  - [[sources/openai-cookbook/articles-codex-exec-plans|Codex Exec Plans]]
  - [[sources/openai-cookbook/examples-gpt-5-codex-prompting-guide|Codex Prompting Guide]]
  - [[sources/openai-cookbook/examples-codex-jira-github|Jira Github]]
  - [[sources/openai-cookbook/examples-codex-secure-quality-gitlab|Secure Quality Gitlab]]
  - [[sources/openai-cookbook/examples-codex-using-goals-in-codex|Using Goals In Codex]]
- Deep Research / MCP
  - [[sources/openai-cookbook/examples-mcp-databricks-mcp-cookbook|Databricks Mcp Cookbook]]
  - [[sources/openai-cookbook/examples-mcp-mcp-tool-guide|Mcp Tool Guide]]
- Evaluation / eval flywheels
  - [[sources/openai-cookbook/examples-evaluation-building-resilient-prompts-using-an-evaluation-flywheel|Building Resilient Prompts Using An Evaluation Flywheel]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-bulk-experimentation|Bulk Experimentation]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-completion-monitoring|Completion Monitoring]]
  - [[sources/openai-cookbook/examples-custom-llm-as-a-judge|Custom Llm As A Judge]]
  - [[sources/openai-cookbook/examples-vector-databases-elasticsearch-elasticsearch-retrieval-augmented-generation|Elasticsearch Retrieval Augmented Generation]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-evalsapi-audio-inputs|Evalsapi Audio Inputs]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-evalsapi-image-inputs|Evalsapi Image Inputs]]
  - [[sources/openai-cookbook/examples-evaluation-evaluate-rag-with-llamaindex|Evaluate Rag With Llamaindex]]
  - [[sources/openai-cookbook/examples-fine-tuned-qa-ft-retrieval-augmented-generation-qdrant|Ft Retrieval Augmented Generation Qdrant]]
  - [[sources/openai-cookbook/examples-evaluation-getting-started-with-openai-evals|Getting Started With Openai Evals]]
  - [[sources/openai-cookbook/examples-how-to-call-functions-for-knowledge-retrieval|How To Call Functions For Knowledge Retrieval]]
  - [[sources/openai-cookbook/examples-evaluation-how-to-eval-abstractive-summarization|How To Eval Abstractive Summarization]]
  - [[sources/openai-cookbook/examples-evaluation-how-to-evaluate-llms-for-sql-generation|How To Evaluate Llms For Sql Generation]]
  - [[sources/openai-cookbook/examples-multimodal-image-evals|Image Evals]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-mcp-eval-notebook|Mcp Eval Notebook]]
  - [[sources/openai-cookbook/examples-realtime-eval-guide|Realtime Eval Guide]]
  - [[sources/openai-cookbook/examples-partners-eval-driven-system-design-receipt-inspection|Receipt Inspection]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-regression|Regression]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-responses-evaluation|Responses Evaluation]]
  - [[sources/openai-cookbook/examples-stripe-model-eval-selecting-a-model-based-on-stripe-conversion|Selecting A Model Based On Stripe Conversion]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-structured-outputs-evaluation|Structured Outputs Evaluation]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-tools-evaluation|Tools Evaluation]]
  - [[sources/openai-cookbook/examples-evaluation-use-cases-web-search-evaluation|Web Search Evaluation]]
- Fine-tuning / reinforcement fine-tuning
  - [[sources/openai-cookbook/examples-chat-finetuning-data-prep|Chat Finetuning Data Prep]]
  - [[sources/openai-cookbook/articles-gpt-oss-fine-tune-korean|Fine Tune Korean]]
  - [[sources/openai-cookbook/articles-gpt-oss-fine-tune-transfomers|Fine Tune Transfomers]]
  - [[sources/openai-cookbook/examples-fine-tuning-direct-preference-optimization-guide|Fine Tuning Direct Preference Optimization Guide]]
  - [[sources/openai-cookbook/examples-fine-tuning-for-function-calling|Fine Tuning For Function Calling]]
  - [[sources/openai-cookbook/examples-third-party-gpt-finetuning-with-wandb|Gpt Finetuning With Wandb]]
  - [[sources/openai-cookbook/examples-how-to-finetune-chat-models|How To Finetune Chat Models]]
  - [[sources/openai-cookbook/examples-reinforcement-fine-tuning|Reinforcement Fine Tuning]]
  - [[sources/openai-cookbook/examples-fine-tuned-qa-reinforcement-finetuning-healthbench|Reinforcement Finetuning Healthbench]]
  - [[sources/openai-cookbook/examples-multimodal-vision-fine-tuning-on-gpt4o-for-visual-question-answering|Vision Fine Tuning On Gpt4o For Visual Question Answering]]
- General OpenAI API patterns
  - [[sources/openai-cookbook/examples-assistants-api-overview-python|Assistants Api Overview Python]]
  - [[sources/openai-cookbook/examples-batch-processing|Batch Processing]]
  - [[sources/openai-cookbook/examples-building-w-rt-mini-building-w-rt-mini|Building W Rt Mini]]
  - [[sources/openai-cookbook/examples-completions-usage-api|Completions Usage Api]]
  - [[sources/openai-cookbook/examples-data-extraction-transformation|Data Extraction Transformation]]
  - [[sources/openai-cookbook/examples-developing-hallucination-guardrails|Developing Hallucination Guardrails]]
  - [[sources/openai-cookbook/examples-enhance-your-prompts-with-meta-prompting|Enhance Your Prompts With Meta Prompting]]
  - [[sources/openai-cookbook/examples-gpt4-1-prompting-guide|Gpt4 1 Prompting Guide]]
  - [[sources/openai-cookbook/examples-how-to-build-an-agent-with-the-node-sdk|How To Build An Agent With The Node Sdk]]
  - [[sources/openai-cookbook/examples-how-to-call-functions-with-chat-models|How To Call Functions With Chat Models]]
  - [[sources/openai-cookbook/examples-how-to-handle-rate-limits|How To Handle Rate Limits]]
  - [[sources/openai-cookbook/examples-how-to-use-guardrails|How To Use Guardrails]]
  - [[sources/openai-cookbook/examples-how-to-use-moderation|How To Use Moderation]]
  - [[sources/openai-cookbook/examples-gpt4o-introduction-to-gpt4o|Introduction To Gpt4o]]
  - [[sources/openai-cookbook/examples-named-entity-recognition-to-enrich-text|Named Entity Recognition To Enrich Text]]
  - [[sources/openai-cookbook/examples-optimize-prompts|Optimize Prompts]]
  - [[sources/openai-cookbook/examples-prompt-caching-201|Prompt Caching 201]]
  - [[sources/openai-cookbook/examples-prompt-caching101|Prompt Caching101]]
  - [[sources/openai-cookbook/examples-prompt-migration-guide|Prompt Migration Guide]]
  - [[sources/openai-cookbook/examples-reproducible-outputs-with-the-seed-parameter|Reproducible Outputs With The Seed Parameter]]
  - [[sources/openai-cookbook/examples-sdg1|Sdg1]]
  - [[sources/openai-cookbook/examples-skills-in-api|Skills In Api]]
  - [[sources/openai-cookbook/examples-summarizing-long-documents|Summarizing Long Documents]]
  - [[sources/openai-cookbook/examples-unit-test-writing-using-a-multi-step-prompt-with-older-completions-api|Unit Test Writing Using A Multi Step Prompt With Older Completions Api]]
  - [[sources/openai-cookbook/examples-using-logprobs|Using Logprobs]]
  - [[sources/openai-cookbook/articles-what-makes-documentation-good|What Makes Documentation Good]]
- GPT-5 / reasoning / prompting
  - [[sources/openai-cookbook/examples-build-a-coding-agent-with-gpt-5-1|Build A Coding Agent With Gpt 5.1]]
  - [[sources/openai-cookbook/examples-gpt-5-gpt-5-1-prompting-guide|Gpt 5 1 Prompting Guide]]
  - [[sources/openai-cookbook/examples-gpt-5-gpt-5-2-prompting-guide|Gpt 5 2 Prompting Guide]]
  - [[sources/openai-cookbook/examples-gpt-5-gpt-5-frontend|Gpt 5 Frontend]]
  - [[sources/openai-cookbook/examples-gpt-5-gpt-5-new-params-and-tools|Gpt 5 New Params And Tools]]
  - [[sources/openai-cookbook/examples-gpt-5-gpt-5-prompting-guide|Gpt 5 Prompting Guide]]
  - [[sources/openai-cookbook/examples-gpt-5-gpt-5-troubleshooting-guide|Gpt 5 Troubleshooting Guide]]
  - [[sources/openai-cookbook/examples-o-series-o3o4-mini-prompting-guide|O3o4 Mini Prompting Guide]]
  - [[sources/openai-cookbook/examples-gpt-5-prompt-optimization-cookbook|Prompt Optimization Cookbook]]
  - [[sources/openai-cookbook/examples-gpt-5-prompt-personalities|Prompt Personalities]]
  - [[sources/openai-cookbook/examples-reasoning-function-calls|Reasoning Function Calls]]
  - [[sources/openai-cookbook/examples-o1-using-reasoning-for-data-validation|Using Reasoning For Data Validation]]
  - [[sources/openai-cookbook/examples-o1-using-reasoning-for-routine-generation|Using Reasoning For Routine Generation]]
- gpt-oss / open-weight deployment
  - [[sources/openai-cookbook/articles-gpt-oss-build-your-own-fact-checker-cerebras|Build Your Own Fact Checker Cerebras]]
  - [[sources/openai-cookbook/articles-gpt-oss-safeguard-guide|Gpt Oss Safeguard Guide]]
  - [[sources/openai-cookbook/articles-gpt-oss-handle-raw-cot|Handle Raw Cot]]
  - [[sources/openai-cookbook/articles-openai-harmony|Openai Harmony]]
  - [[sources/openai-cookbook/articles-gpt-oss-run-colab|Run Colab]]
  - [[sources/openai-cookbook/articles-gpt-oss-run-locally-lmstudio|Run Locally Lmstudio]]
  - [[sources/openai-cookbook/articles-gpt-oss-run-locally-ollama|Run Locally Ollama]]
  - [[sources/openai-cookbook/articles-gpt-oss-run-nvidia|Run Nvidia]]
  - [[sources/openai-cookbook/articles-gpt-oss-run-transformers|Run Transformers]]
  - [[sources/openai-cookbook/articles-gpt-oss-run-vllm|Run Vllm]]
  - [[sources/openai-cookbook/articles-gpt-oss-verifying-implementations|Verifying Implementations]]
- Multimodal / image / video
  - [[sources/openai-cookbook/examples-creating-slides-with-assistants-api-and-dall-e3|Creating Slides With Assistants Api And Dall E3]]
  - [[sources/openai-cookbook/examples-multimodal-document-and-multimodal-understanding-tips|Document And Multimodal Understanding Tips]]
  - [[sources/openai-cookbook/examples-generate-images-with-gpt-image|Generate Images With Gpt Image]]
  - [[sources/openai-cookbook/examples-generate-images-with-high-input-fidelity|Generate Images With High Input Fidelity]]
  - [[sources/openai-cookbook/examples-gpt-with-vision-for-video-understanding|Gpt With Vision For Video Understanding]]
  - [[sources/openai-cookbook/examples-multimodal-grounded-spatial-reasoning-layouts|Grounded Spatial Reasoning Layouts]]
  - [[sources/openai-cookbook/examples-dalle-how-to-create-dynamic-masks-with-dall-e-and-segment-anything|How To Create Dynamic Masks With Dall E And Segment Anything]]
  - [[sources/openai-cookbook/examples-multimodal-image-gen-1-5-prompting-guide|Image Gen 1.5 Prompting Guide]]
  - [[sources/openai-cookbook/examples-multimodal-image-gen-models-prompting-guide|Image Gen Models Prompting Guide]]
  - [[sources/openai-cookbook/examples-sora-sora2-prompting-guide|Sora2 Prompting Guide]]
  - [[sources/openai-cookbook/examples-tag-caption-images-with-gpt4v|Tag Caption Images With Gpt4v]]
  - [[sources/openai-cookbook/examples-multimodal-using-gpt4-vision-with-function-calling|Using Gpt4 Vision With Function Calling]]
  - [[sources/openai-cookbook/articles-what-is-new-with-dalle-3|What Is New With Dalle 3]]
- RAG / retrieval / vector databases
  - [[sources/openai-cookbook/examples-custom-image-embedding-search|Custom Image Embedding Search]]
  - [[sources/openai-cookbook/examples-vector-databases-deeplake-deeplake-langchain-qa|Deeplake Langchain Qa]]
  - [[sources/openai-cookbook/examples-vector-databases-elasticsearch-elasticsearch-semantic-search|Elasticsearch Semantic Search]]
  - [[sources/openai-cookbook/examples-embedding-wikipedia-articles-for-search|Embedding Wikipedia Articles For Search]]
  - [[sources/openai-cookbook/examples-file-search-responses|File Search Responses]]
  - [[sources/openai-cookbook/examples-vector-databases-weaviate-generative-search-with-weaviate-and-openai|Generative Search With Weaviate And Openai]]
  - [[sources/openai-cookbook/examples-vector-databases-azuresearch-getting-started-with-azure-ai-search-and-openai|Getting Started With Azure Ai Search And Openai]]
  - [[sources/openai-cookbook/examples-vector-databases-hologres-getting-started-with-hologres-and-openai|Getting Started With Hologres And Openai]]
  - [[sources/openai-cookbook/examples-vector-databases-polardb-getting-started-with-polardb-and-openai|Getting Started With Polardb And Openai]]
  - [[sources/openai-cookbook/examples-vector-databases-tair-getting-started-with-tair-and-openai|Getting Started With Tair And Openai]]
  - [[sources/openai-cookbook/examples-third-party-how-to-automate-s3-storage-with-functions|How To Automate S3 Storage With Functions]]
  - [[sources/openai-cookbook/examples-how-to-combine-gpt4o-with-rag-outfit-assistant|How To Combine Gpt4o With Rag Outfit Assistant]]
  - [[sources/openai-cookbook/examples-vector-databases-chroma-hyde-with-chroma-and-openai|Hyde With Chroma And Openai]]
  - [[sources/openai-cookbook/examples-multimodal-image-understanding-with-rag|Image Understanding With Rag]]
  - [[sources/openai-cookbook/examples-deep-research-api-introduction-to-deep-research-api|Introduction To Deep Research Api]]
  - [[sources/openai-cookbook/examples-deep-research-api-introduction-to-deep-research-api-agents|Introduction To Deep Research Api Agents]]
  - [[sources/openai-cookbook/examples-leveraging-model-distillation-to-fine-tune-a-model|Leveraging Model Distillation To Fine Tune A Model]]
  - [[sources/openai-cookbook/examples-vector-databases-neon-neon-postgres-vector-search-pgvector|Neon Postgres Vector Search Pgvector]]
  - [[sources/openai-cookbook/examples-vector-databases-singlestoredb-openai-wikipedia-semantic-search|Openai Wikipedia Semantic Search]]
  - [[sources/openai-cookbook/examples-parse-pdf-docs-for-rag|Parse Pdf Docs For Rag]]
  - [[sources/openai-cookbook/examples-vector-databases-cassandra-astradb-philosophical-quotes-cassio|Philosophical Quotes Cassio]]
  - [[sources/openai-cookbook/examples-vector-databases-cassandra-astradb-philosophical-quotes-cql|Philosophical Quotes Cql]]
  - [[sources/openai-cookbook/examples-vector-databases-tair-qa-with-langchain-tair-and-openai|Qa With Langchain Tair And Openai]]
  - [[sources/openai-cookbook/examples-question-answering-using-a-search-api|Question Answering Using A Search Api]]
  - [[sources/openai-cookbook/examples-rag-with-graph-db|Rag With Graph Db]]
  - [[sources/openai-cookbook/examples-vector-databases-singlestoredb-readme|Readme]]
  - [[sources/openai-cookbook/examples-vector-databases-supabase-readme|Readme]]
  - [[sources/openai-cookbook/examples-vector-databases-readme|Readme]]
  - [[sources/openai-cookbook/examples-vector-databases-neon-readme|Readme]]
  - [[sources/openai-cookbook/examples-deep-research-api-how-to-build-a-deep-research-mcp-server-readme|Readme]]
  - [[sources/openai-cookbook/examples-vector-databases-mongodb-atlas-readme|Readme]]
  - [[sources/openai-cookbook/examples-vector-databases-elasticsearch-readme|Readme]]
  - [[sources/openai-cookbook/examples-vector-databases-cassandra-astradb-readme|Readme]]
  - [[sources/openai-cookbook/examples-search-reranking-with-cross-encoders|Search Reranking With Cross Encoders]]
  - [[sources/openai-cookbook/examples-vector-databases-supabase-semantic-search|Semantic Search]]
  - [[sources/openai-cookbook/examples-vector-databases-mongodb-atlas-semantic-search-using-mongodb-atlas-vector-search|Semantic Search Using Mongodb Atlas Vector Search]]
  - [[sources/openai-cookbook/examples-vector-databases-chroma-using-chroma-for-embeddings-search|Using Chroma For Embeddings Search]]
  - [[sources/openai-cookbook/examples-vector-databases-myscale-using-myscale-for-embeddings-search|Using Myscale For Embeddings Search]]
  - [[sources/openai-cookbook/examples-vector-databases-pinecone-using-pinecone-for-embeddings-search|Using Pinecone For Embeddings Search]]
  - [[sources/openai-cookbook/examples-vector-databases-qdrant-using-qdrant-for-embeddings-search|Using Qdrant For Embeddings Search]]
  - [[sources/openai-cookbook/examples-vector-databases-redis-using-redis-for-embeddings-search|Using Redis For Embeddings Search]]
  - [[sources/openai-cookbook/examples-vector-databases-typesense-using-typesense-for-embeddings-search|Using Typesense For Embeddings Search]]
  - [[sources/openai-cookbook/examples-vector-databases-pinecone-using-vision-modality-for-rag-with-pinecone|Using Vision Modality For Rag With Pinecone]]
  - [[sources/openai-cookbook/examples-vector-databases-weaviate-using-weaviate-for-embeddings-search|Using Weaviate For Embeddings Search]]
  - [[sources/openai-cookbook/examples-third-party-visualizing-embeddings-in-kangas|Visualizing Embeddings In Kangas]]
  - [[sources/openai-cookbook/examples-third-party-web-search-with-google-api-bring-your-own-browser-tool|Web Search With Google Api Bring Your Own Browser Tool]]
- Realtime / voice / transcription
  - [[sources/openai-cookbook/examples-context-summarization-with-realtime-api|Context Summarization With Realtime Api]]
  - [[sources/openai-cookbook/examples-data-intensive-realtime-apps|Data Intensive Realtime Apps]]
  - [[sources/openai-cookbook/examples-partners-mcp-powered-voice-agents-mcp-powered-agents-cookbook|Mcp Powered Agents Cookbook]]
  - [[sources/openai-cookbook/examples-voice-solutions-one-way-translation-using-realtime-api|One Way Translation Using Realtime Api]]
  - [[sources/openai-cookbook/examples-realtime-out-of-band-transcription|Realtime Out Of Band Transcription]]
  - [[sources/openai-cookbook/examples-realtime-prompting-guide|Realtime Prompting Guide]]
  - [[sources/openai-cookbook/examples-voice-solutions-realtime-translation-guide|Realtime Translation Guide]]
  - [[sources/openai-cookbook/examples-voice-solutions-running-realtime-api-speech-on-esp32-arduino-edge-runtime-elatoai|Running Realtime Api Speech On Esp32 Arduino Edge Runtime Elatoai]]
  - [[sources/openai-cookbook/examples-speech-transcription-methods|Speech Transcription Methods]]
  - [[sources/openai-cookbook/examples-voice-solutions-steering-tts|Steering Tts]]
  - [[sources/openai-cookbook/examples-voice-solutions-voice-translation-into-different-languages-using-gpt-4o|Voice Translation Into Different Languages Using Gpt 4O]]
  - [[sources/openai-cookbook/examples-whisper-correct-misspelling|Whisper Correct Misspelling]]
  - [[sources/openai-cookbook/examples-whisper-processing-guide|Whisper Processing Guide]]
  - [[sources/openai-cookbook/examples-whisper-prompting-guide|Whisper Prompting Guide]]
- Responses API / tool orchestration
  - [[sources/openai-cookbook/examples-responses-api-reasoning-items|Reasoning Items]]
  - [[sources/openai-cookbook/examples-responses-api-responses-api-tool-orchestration|Responses Api Tool Orchestration]]
  - [[sources/openai-cookbook/examples-responses-api-responses-example|Responses Example]]
- Structured outputs / function calling
  - [[sources/openai-cookbook/examples-function-calling-finding-nearby-places|Function Calling Finding Nearby Places]]
  - [[sources/openai-cookbook/examples-function-calling-with-an-openapi-spec|Function Calling With An Openapi Spec]]
  - [[sources/openai-cookbook/examples-structured-outputs-intro|Structured Outputs Intro]]
  - [[sources/openai-cookbook/examples-structured-outputs-multi-agent|Structured Outputs Multi Agent]]
  - [[sources/openai-cookbook/examples-o1-using-chained-calls-for-o1-structured-outputs|Using Chained Calls For O1 Structured Outputs]]
  - [[sources/openai-cookbook/examples-using-tool-required-for-customer-service|Using Tool Required For Customer Service]]
- Third-party integrations
  - [[sources/openai-cookbook/examples-partners-agentic-governance-guide-agentic-governance-cookbook|Agentic Governance Cookbook]]
  - [[sources/openai-cookbook/examples-partners-self-evolving-agents-autonomous-agent-retraining|Autonomous Agent Retraining]]
  - [[sources/openai-cookbook/examples-azure-chat-with-your-own-data|Chat With Your Own Data]]
  - [[sources/openai-cookbook/examples-third-party-code-quality-and-security-scan-with-github-actions|Code Quality And Security Scan With Github Actions]]
  - [[sources/openai-cookbook/examples-third-party-financial-document-analysis-with-llamaindex|Financial Document Analysis With Llamaindex]]
  - [[sources/openai-cookbook/examples-azure-functions|Functions]]
  - [[sources/openai-cookbook/examples-partners-model-selection-guide-model-selection-guide|Model Selection Guide]]
  - [[sources/openai-cookbook/examples-third-party-openai-monitoring-with-wandb-weave|Openai Monitoring With Wandb Weave]]
  - [[sources/openai-cookbook/examples-partners-temporal-agents-with-knowledge-graphs-temporal-agents|Temporal Agents]]
## Topics
...
- [[frontend-frameworks-public]] - Curated public corpus for reusable frontend project shells, documentation/wiki frameworks, app frameworks, build tooling, and release ideas.
...
- [[entities/frontend-frameworks/angular|Angular]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/astro|Astro]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/docusaurus|Docusaurus]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/fumadocs|Fumadocs]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/nextjs|Next.js]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/nextra|Nextra]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/nitro|Nitro]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/nuxt|Nuxt]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/quartz|Quartz]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/qwik|Qwik]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/react|React]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/remix-react-router|Remix / React Router]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/solid|Solid]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/starlight|Starlight]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/svelte|Svelte]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/sveltekit|SvelteKit]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/tanstack-start|TanStack Start]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/vite|Vite]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/vitepress|VitePress]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.
- [[entities/frontend-frameworks/vue|Vue]] - Project framework entity page with reuse profile, shell score, curated repos, releases, docs, and navigation.

### Repository Sources

- [[sources/frontend-frameworks/angular-angular|angular/angular]] - GitHub repo source page for Angular, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/angular-angular-cli|angular/angular-cli]] - GitHub repo source page for Angular, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/angular-components|angular/components]] - GitHub repo source page for Angular, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/facebook-docusaurus|facebook/docusaurus]] - GitHub repo source page for Docusaurus, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/facebook-react|facebook/react]] - GitHub repo source page for React, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/fuma-nama-fumadocs|fuma-nama/fumadocs]] - GitHub repo source page for Fumadocs, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/jackyzha0-quartz|jackyzha0/quartz]] - GitHub repo source page for Quartz, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/nitrojs-nitro|nitrojs/nitro]] - GitHub repo source page for Nitro, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/nuxt-content|nuxt/content]] - GitHub repo source page for Nuxt, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/nuxt-image|nuxt/image]] - GitHub repo source page for Nuxt, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/nuxt-nuxt|nuxt/nuxt]] - GitHub repo source page for Nuxt, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/nuxt-ui|nuxt/ui]] - GitHub repo source page for Nuxt, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/qwikdev-qwik|QwikDev/qwik]] - GitHub repo source page for Qwik, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/reactjs-react-dev|reactjs/react.dev]] - GitHub repo source page for React, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/remix-run-react-router|remix-run/react-router]] - GitHub repo source page for Remix / React Router, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/remix-run-remix|remix-run/remix]] - GitHub repo source page for Remix / React Router, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/shuding-nextra|shuding/nextra]] - GitHub repo source page for Nextra, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/solidjs-solid|solidjs/solid]] - GitHub repo source page for Solid, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/solidjs-solid-docs|solidjs/solid-docs]] - GitHub repo source page for Solid, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/solidjs-solid-start|solidjs/solid-start]] - GitHub repo source page for Solid, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/sveltejs-kit|sveltejs/kit]] - GitHub repo source page for SvelteKit, Svelte, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/sveltejs-svelte|sveltejs/svelte]] - GitHub repo source page for Svelte, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/sveltejs-svelte-dev|sveltejs/svelte.dev]] - GitHub repo source page for Svelte, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/tanstack-router|TanStack/router]] - GitHub repo source page for TanStack Start, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vercel-next-js|vercel/next.js]] - GitHub repo source page for Next.js, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vitejs-vite|vitejs/vite]] - GitHub repo source page for Vite, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vitejs-vite-plugin-react|vitejs/vite-plugin-react]] - GitHub repo source page for Vite, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vuejs-core|vuejs/core]] - GitHub repo source page for Vue, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vuejs-devtools|vuejs/devtools]] - GitHub repo source page for Vue, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vuejs-docs|vuejs/docs]] - GitHub repo source page for Vue, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vuejs-pinia|vuejs/pinia]] - GitHub repo source page for Vue, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vuejs-router|vuejs/router]] - GitHub repo source page for Vue, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/vuejs-vitepress|vuejs/vitepress]] - GitHub repo source page for VitePress, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/withastro-astro|withastro/astro]] - GitHub repo source page for Astro, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/withastro-docs|withastro/docs]] - GitHub repo source page for Astro, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.
- [[sources/frontend-frameworks/withastro-starlight|withastro/starlight]] - GitHub repo source page for Starlight, Astro, reuse profile, docs/demo links, language profile, release pointer, hashes, and metadata.

### Release Sources

- [[sources/frontend-frameworks/releases/angular-angular-v20-3-21|angular/angular v20.3.21]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-angular-v21-2-13|angular/angular v21.2.13]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-angular-v22-0-0-rc-0|angular/angular v22.0.0-rc.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-angular-cli-v20-3-26|angular/angular-cli v20.3.26]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-angular-cli-v21-2-11|angular/angular-cli v21.2.11]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-angular-cli-v22-0-0-rc-0|angular/angular-cli v22.0.0-rc.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-components-v21-2-11|angular/components v21.2.11]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-components-v22-0-0-next-8|angular/components v22.0.0-next.8]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/angular-components-v22-0-0-rc-0|angular/components v22.0.0-rc.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/facebook-docusaurus-v3-10-0|facebook/docusaurus v3.10.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/facebook-docusaurus-v3-10-1|facebook/docusaurus v3.10.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/facebook-docusaurus-v3-9-2|facebook/docusaurus v3.9.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/facebook-react-v19-0-6|facebook/react v19.0.6]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/facebook-react-v19-1-7|facebook/react v19.1.7]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/facebook-react-v19-2-6|facebook/react v19.2.6]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/fuma-nama-fumadocs-fumadocs-local-md-0-2-2|fuma-nama/fumadocs @fumadocs/local-md@0.2.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/fuma-nama-fumadocs-fumadocs-sanity-0-0-4|fuma-nama/fumadocs @fumadocs/sanity@0.0.4]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/fuma-nama-fumadocs-fumadocs-mdx-15-0-5|fuma-nama/fumadocs fumadocs-mdx@15.0.5]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/jackyzha0-quartz-v3-2|jackyzha0/quartz v3.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/jackyzha0-quartz-v3-3|jackyzha0/quartz v3.3]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/jackyzha0-quartz-v4-0-8|jackyzha0/quartz v4.0.8]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nitrojs-nitro-v2-13-4|nitrojs/nitro v2.13.4]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nitrojs-nitro-v3-0-260415-beta|nitrojs/nitro v3.0.260415-beta]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nitrojs-nitro-v3-0-260429-beta|nitrojs/nitro v3.0.260429-beta]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-content-v3-11-2|nuxt/content v3.11.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-content-v3-12-0|nuxt/content v3.12.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-content-v3-13-0|nuxt/content v3.13.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-image-v1-11-0|nuxt/image v1.11.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-image-v2-0-0|nuxt/image v2.0.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-image-v2-0-0-alpha-1|nuxt/image v2.0.0-alpha.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-nuxt-v3-21-5|nuxt/nuxt v3.21.5]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-nuxt-v4-4-3|nuxt/nuxt v4.4.3]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-nuxt-v4-4-5|nuxt/nuxt v4.4.5]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-ui-v4-6-1|nuxt/ui v4.6.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-ui-v4-7-0|nuxt/ui v4.7.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/nuxt-ui-v4-7-1|nuxt/ui v4.7.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/qwikdev-qwik-qwik-dev-optimizer-2-1-0-beta-4|QwikDev/qwik @qwik.dev/optimizer@2.1.0-beta.4]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/qwikdev-qwik-qwik-dev-react-2-0-0-beta-35|QwikDev/qwik @qwik.dev/react@2.0.0-beta.35]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/qwikdev-qwik-qwik-dev-router-2-0-0-beta-35|QwikDev/qwik @qwik.dev/router@2.0.0-beta.35]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/remix-run-react-router-react-router-7-14-2|remix-run/react-router react-router@7.14.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/remix-run-react-router-react-router-7-15-0|remix-run/react-router react-router@7.15.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/remix-run-react-router-react-router-7-15-1|remix-run/react-router react-router@7.15.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/remix-run-remix-static-middleware-0-4-8|remix-run/remix static-middleware@0.4.8]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/remix-run-remix-test-0-3-0|remix-run/remix test@0.3.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/remix-run-remix-ui-0-1-1|remix-run/remix ui@0.1.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/shuding-nextra-nextra-4-6-1|shuding/nextra nextra@4.6.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/shuding-nextra-nextra-theme-blog-4-6-1|shuding/nextra nextra-theme-blog@4.6.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/shuding-nextra-nextra-theme-docs-4-6-1|shuding/nextra nextra-theme-docs@4.6.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/solidjs-solid-v1-8-0|solidjs/solid v1.8.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/solidjs-solid-v1-9-0|solidjs/solid v1.9.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/solidjs-solid-v2-0-0-beta-0|solidjs/solid v2.0.0-beta.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/solidjs-solid-start-solidjs-start-1-3-0|solidjs/solid-start @solidjs/start@1.3.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/solidjs-solid-start-solidjs-start-1-3-1|solidjs/solid-start @solidjs/start@1.3.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/solidjs-solid-start-solidjs-start-1-3-2|solidjs/solid-start @solidjs/start@1.3.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/sveltejs-kit-sveltejs-kit-2-59-1|sveltejs/kit @sveltejs/kit@2.59.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/sveltejs-kit-sveltejs-kit-2-60-0|sveltejs/kit @sveltejs/kit@2.60.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/sveltejs-kit-sveltejs-kit-2-60-1|sveltejs/kit @sveltejs/kit@2.60.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/sveltejs-svelte-svelte-5-55-5|sveltejs/svelte svelte@5.55.5]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/sveltejs-svelte-svelte-5-55-6|sveltejs/svelte svelte@5.55.6]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/sveltejs-svelte-svelte-5-55-7|sveltejs/svelte svelte@5.55.7]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/tanstack-router-tanstack-start-plugin-core-1-170-2|TanStack/router @tanstack/start-plugin-core@1.170.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/tanstack-router-tanstack-vue-start-1-168-2|TanStack/router @tanstack/vue-start@1.168.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/tanstack-router-release-2026-05-16-0506|TanStack/router release-2026-05-16-0506]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vercel-next-js-v16-3-0-canary-19|vercel/next.js v16.3.0-canary.19]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vercel-next-js-v16-3-0-canary-20|vercel/next.js v16.3.0-canary.20]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vercel-next-js-v16-3-0-canary-21|vercel/next.js v16.3.0-canary.21]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vitejs-vite-plugin-legacy-8-0-2|vitejs/vite plugin-legacy@8.0.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vitejs-vite-v8-0-12|vitejs/vite v8.0.12]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vitejs-vite-v8-0-13|vitejs/vite v8.0.13]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vitejs-vite-plugin-react-plugin-react-6-0-2|vitejs/vite-plugin-react plugin-react@6.0.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vitejs-vite-plugin-react-plugin-react-swc-4-3-1|vitejs/vite-plugin-react plugin-react-swc@4.3.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vitejs-vite-plugin-react-plugin-rsc-0-5-26|vitejs/vite-plugin-react plugin-rsc@0.5.26]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-core-v3-5-34|vuejs/core v3.5.34]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-core-v3-6-0-beta-11|vuejs/core v3.6.0-beta.11]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-core-v3-6-0-beta-12|vuejs/core v3.6.0-beta.12]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-devtools-v8-1-0|vuejs/devtools v8.1.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-devtools-v8-1-1|vuejs/devtools v8.1.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-devtools-v8-1-2|vuejs/devtools v8.1.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-pinia-v3-0-2|vuejs/pinia v3.0.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-pinia-v3-0-3|vuejs/pinia v3.0.3]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-pinia-v3-0-4|vuejs/pinia v3.0.4]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-router-v5-0-5|vuejs/router v5.0.5]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-router-v5-0-6|vuejs/router v5.0.6]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-router-v5-0-7|vuejs/router v5.0.7]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-vitepress-v2-0-0-alpha-15|vuejs/vitepress v2.0.0-alpha.15]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-vitepress-v2-0-0-alpha-16|vuejs/vitepress v2.0.0-alpha.16]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/vuejs-vitepress-v2-0-0-alpha-17|vuejs/vitepress v2.0.0-alpha.17]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/withastro-astro-astrojs-mdx-5-0-6|withastro/astro @astrojs/mdx@5.0.6]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/withastro-astro-astro-6-3-2|withastro/astro astro@6.3.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/withastro-astro-astro-6-3-3|withastro/astro astro@6.3.3]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/withastro-starlight-astrojs-starlight-0-39-0|withastro/starlight @astrojs/starlight@0.39.0]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/withastro-starlight-astrojs-starlight-0-39-1|withastro/starlight @astrojs/starlight@0.39.1]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
- [[sources/frontend-frameworks/releases/withastro-starlight-astrojs-starlight-0-39-2|withastro/starlight @astrojs/starlight@0.39.2]] - Captured GitHub release summary, project-shell idea bullets, and body hash.
...
- [[sources/codex-prompts/codex-user-prompt-f95d989c872c4ba4|elmrec-official] epoch=75 train_loss=0.022439]] - `codex-user-prompt:f95d989c872c4ba4`
- [[sources/codex-prompts/codex-user-prompt-75ead59f47dfc24b|[elmrec-official] epoch=75 train_loss=0.022439]] - `codex-user-prompt:75ead59f47dfc24b`
- [[sources/codex-prompts/codex-user-prompt-453e81fdc20c4306|[proex-official] epoch=2970 train_loss=7.186873]] - `codex-user-prompt:453e81fdc20c4306`
...
- [[sources/codex-prompts/codex-user-prompt-6d3b1656dd0d215e|[promax-official] epoch=2980 train_loss=1.700973]] - `codex-user-prompt:6d3b1656dd0d215e`
