...
| `D:/DELVTOOLS_PUBLIC` / `D:/devtools-public` | Clean public export of safe launchers, docs, templates, and safety checks. `D:/DELVTOOLS_PUBLIC` is the current local checkout; `devtools-public` is the GitHub and historical local name. | `AGENTS.md`, README, safety gate scripts, Git tags. |
...
| `D:/AGENTIC_SCIENCE` | Public agentic-science methods repo containing UUPF, a 108-pass audit/upgrade forge used for skill/workflow review. | `AGENTS.md`, `README.md`, `uupf/UniversalUpgradeForge.zip`; keep raw UUPF runs in target ignored work areas unless curated. |
| `D:/Research/WEIPING_LAB` / `D:/Research/vipin-lab` | Honest research workbench for artifacts, evidence packets, validation reports, and research-state operations. | `AGENTS.md`, `README.md`, `CLAUDE.md`, `.codex/skills/weiping-lab/SKILL.md`, `docs/`, tests. |
| `D:/Research/WEIPING_COUNCIL` / `D:/Research/vipin-council` | Multi-model deliberation runtime and companion review layer for lab/research artifacts. | `AGENTS.md`, `README.md`, `CLAUDE.md`, `.codex/skills/weiping-council/SKILL.md`, backend/frontend docs, tests. |
