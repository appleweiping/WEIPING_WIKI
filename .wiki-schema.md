...
Create missing homes, update stale or weak pages, merge duplicates, and delete pages whose continued presence lowers retrieval quality, accuracy, safety, or usability.
...
- `maintain` performs evidence-disciplined CRUD cleanup and should not be biased toward accumulation.
